				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Our Staff Add</h5>
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" action="../controller/ourStaffController.php" method="POST" enctype="multipart/form-data">
								...
								<div class="text-right">
									...
									<button type="submit" class="btn btn-primary" name="saveOurStaff">Submit <i class="icon-arrow-right14 position-right"></i></button>
								</div>
							</form>
